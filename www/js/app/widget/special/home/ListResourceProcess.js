define([
    ...
    return declare("app.widget.special.home.ListResourceProcess", [RoundRectStoreList, StoredData], {
        ...
        postCreate: function () {
            ...
            this.resourceSubscriber = topic.subscribe("/resourceProcessList/there.are", lang.hitch(this, this.thereAre));
            this.gotoTopSubscriber = topic.subscribe("/resourceProcessList/goto.top", lang.hitch(this, this.gotoTop));
            this.gotoBottomSubscriber = topic.subscribe("/resourceProcessList/goto.bottom", lang.hitch(this, this.gotoBottom));
        },
        destroy: function () {
            this.inherited(arguments);
