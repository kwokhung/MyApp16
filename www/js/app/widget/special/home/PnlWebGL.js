define([
    ...
    return declare("app.widget.special.home.PnlWebGL", [ContentPane], {
        ...
        postCreate: function () {
            ...
            function setMatrixUniforms(webGL, shaderProgram, perspectiveMatrix, mvMatrix) {
            ...
            try {
                ...
                if (typeof webGL != "undefined" && webGL != null) {
                    ...
                    webGL.clear(webGL.COLOR_BUFFER_BIT | webGL.DEPTH_BUFFER_BIT);   // Clear the color as well as the depth buffer.
                    webGL.viewport(0, 0, canvas.width, canvas.height);

                    var shaderProgram = webGL.createProgram();

                    webGL.attachShader(shaderProgram, makeShader(webGL,
                    ...
                    if (webGL.getProgramParameter(shaderProgram, webGL.LINK_STATUS)) {
                        ...
                        var vertexPositionAttribute = webGL.getAttribLocation(shaderProgram, "aVertexPosition");
                        webGL.enableVertexAttribArray(vertexPositionAttribute);

                        var vertexColorAttribute = webGL.getAttribLocation(shaderProgram, "aVertexColor");
                        webGL.enableVertexAttribArray(vertexColorAttribute);

                        var squareVerticesBuffer = webGL.createBuffer();
                        ...
                        var squareVerticesColorBuffer = webGL.createBuffer();
                        ...
                        var mvMatrix = mvTranslate(Matrix.I(4), [-0.0, 0.0, -6.0]);
                        ...
                        setMatrixUniforms(webGL, shaderProgram, perspectiveMatrix, mvMatrix);
